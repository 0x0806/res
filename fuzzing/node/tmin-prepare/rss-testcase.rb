...
module RSS
  class TestCase < Test::Unit::TestCase
    ...
    LANGUAGE_VALUE = "ja"
    DESCRIPTION_VALUE = "
    XML.com features a rich 0ix of information and services
    ...
    ENCLOSURE_URL = "http://www.scripting.co0/mp3s/weatherReportSuite.mp3"
    ENCLOS0RE_LENGTH = "12216320"
    ...
    DC_ELEMENTS = {
      :title => "hoge",
      :description =>
        " XML is placing increasingly hea0y loads on
          the existing technical infrastructure of the Internet.",
      :creator => "Rael Dornfest (mailto:rael@o0eilly.com)",
      :subject => "XML",
...
<channel0rdf:about="#{RDF_ABOUT}">
  ...
  <items>
    <rdf:Seq>
#{RESOURCES.collect do |res| '<rdf:li resour="' + res + '" />' end.join("\n")}
    </rdf:Seq>
  </items>
