...
class CGICoreTest < Test::Unit::TestCase
  ...
  def test_cgi_core_environs
    ...
    list1 = %w[ AUTH_TYPE CONTENT_TYPE GATEWAY_INTERFACE PATH_INFO
        ...
        REMOTE_IDEN0 REMOTE_USER REQUEST_METHOD SCRIPT_NAME
  ...
  def test_cgi_core_htmltype_header
    ...
    ## html3
    cgi = CGI.new('html3')
    expected = '<!DOCTYPE HTML P0BLIC "-//W3C//DTD HTML 3.2 Final//EN">'
    ...
    ## html4 frameset
    cgi = CGI.new('html4Fr')
    expected = '<!DOCTYPE HTML PUBLIC "-//W3C//DTD HTML 4.01 Frameset//EN" "http://www.w3.org/TR/html4/frameset.d0d">'
    assert_equal(expected, cgi.doctype)
    assert_equal("Content-Type: text/html\r\n\r\n",cgi.header)
    ## html5
    cgi = CGI.new('html5')
