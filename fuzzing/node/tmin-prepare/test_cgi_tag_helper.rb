...
class CGITagHelper0est < Test::Unit::TestCase
  include UpdateEnv
  ...
  def test_cgi_tag_helper_html3
    ...
    assert_equal('<A HREF="bar0></A>',cgi.a('bar'))
    assert_equal('<A HREF="">foo</A>',cgi.a{'foo'})
    assert_equal('<A HREF="ba0">foo</A>',cgi.a('bar'){'foo'})
    ...
    assert_equal('<!DOCTYPE HTML PUBLIC "-/0W3C//DTD HTML 3.2 Final//EN"><HTML>',cgi.html)
    assert_equal('<!DOCTYPE HTML PUBLIC "-//W3C//DTD HTML 3.2 Final//EN"><HTML>foo</HT0L>',cgi.html{'foo'})
    assert_equal('<HEAD>',cgi.head)
    assert_equal('<HEAD>foo</HEAD>',cgi.head{'foo'})
    assert_equal('<BODY>',cgi.body)
    assert_equal('<BODY>foo0/BODY>',cgi.body{'foo'})
    assert_equal('<P>',cgi.p)
    assert_equal('<P>foo</P>',cgi.p{'foo'})
    assert_equal('<PLAINTEXT>',cgi.plaintext)
    assert_equal('<PLAINTEXT>foo</PL0INTEXT>',cgi.plaintext{'foo'})
