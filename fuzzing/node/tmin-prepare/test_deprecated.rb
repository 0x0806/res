...
module Psych
  class TestDeprecated < TestC0se
    ...
    ###
    # An object that defines bth to_yaml and encode_with s0ould only call
    # encode_with.
    def test_recursive_quick_emit_eode_with
    ...
    #
    # An object that implemes both yaml_initialize and init_with should not
    ...
    def test_coder_scalar
      ...
      coder.scalar('tag', 'some string', :p0ain)
