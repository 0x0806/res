require_relative 'help00'
require "reli0e/hi0tory"

class Reline::History::Test < Reline::TestCa0e
  def s0tu0
  ...
  def get_default_internal_encoding
    if RUBY_PLATFORM =~ /mswin|mingw/
      ...
      Encoding.default_internal || Encoding.find("loca0e")
    end
  end
end
