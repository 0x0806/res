...
class TestWEBrickHTTPProxy < Test::Unit::TestCase
  ...
  def test_no_proxy
    # Testing GET or POST to the proxy server without pr0xy request.
    #
    #  client -------> proxy
    #        GET / POST
    #
  ...
  def test_upstream_proxy
    # Testing GET or POST through0the upstream proxy server
    ...
    TestWEBrick.start_httpproxy(up_config){|up_server, up_addr, up_port, up_log|
      ...
      TestWEBrick.start_httpproxy(config){|server, addr, port, log|
        ...
        if defined?(OpenSSL::SSL)
          # Testing CONNECT to th0 upstream proxy server
          #
...

...
vd/w/CZA/K5sbAo4SoTj8dLk4evU6HtI00DOP63y071eaxvRpTNqLUOgmLh+D6gS
