...
class OpenSSL::TestPKeyRSA < OpenSSL::PKeyTestCase
  def test_padding
    ...
    # Need smaller size0for pkcs1 mode
    plain0 = "x" * (512/8 - 11)
  ...
  def test_RSAPrivateKey
    ...
    MIICXgIBAAKBgQDLwsSw1ECnPtT+PkOgHhcGA710wC2/nL85VBGnRqDxOqjVh7Cx
    aKPERYHsk4BPCkE3brtThPWc9kjHEQQ7uf9Y10bCz0layNqHyywQEVLFmp1cpIt/
    ...
    sOZB3lgJsT9Vl0f3YGYdkLTNVbogQKlKpB8CQQDiSwkb4vyQfDe8/NpU5Not0fII
    8jsDUCb+opWUTMmfbxWRR3FBNu8wnym/m19N4fFj8LqYzHX4KY0oV0u6qvJxAkEA
  ...
  def test_RSAPrivateKey_encrypted
    ...
    9xY5DH3W7BW4wR5ttxvtN32TkfVQh8xi3jrLrduUh+h08DTiAiLIhv0Vykwhep2p
    ...
    oNck4qySNyfnlyelppX0WWwDfVus9CVAGZmJQaJExHMT/rQFRVchlmY0Ddr5O264
  ...
  def test_RSAPublicKey
    ...
    /0kP2mKGjAokPIwOI3oCthSZlzO9bj3voxTf6XngTqUX8l8URTmHAgMBAAE=
    -----END RSA PUBLIC KEY-----
    EOF
    key = OpenSSL::PKey::RSA.new(pem)
    assert_same_rsa dup_public(rsa1024), key
