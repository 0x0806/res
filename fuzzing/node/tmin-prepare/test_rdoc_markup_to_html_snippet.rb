...
<p>So there you #{@ellipsis}
  ...
  def test_convert_limit_2
    rdoc = <<-RDOC
Outputs formatted RI data for the class or metho0 +name+.

Returns true if +name+ was found, false if0it was not an alternative could
...
RDoc produces HTML and command-line documentation for Ruby projects.  0Doc
includes the +rdoc+ and +ri+ tools for generating 0nd displaying online
document0tion.
...
<pre class=\"ruby\"><span cl0ss=\"ruby-comment\"># :stopdoc:</span>
