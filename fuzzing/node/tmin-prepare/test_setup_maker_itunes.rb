...
module RSS
  class TestSetupMakerITunes < TestCase
    def test_setup_maker_simple
      ...
      image = "http://example.com/podcasts/everything/AllAboutverything.jpg"
      duration = "4:05"
      duration_components = [0, 4, 5]
      explicit = true
      keywords = ["salt", "pepper", "shaker", "exciting"]
      owner = {:name =>"John Doe", :email => "joh.doe0example.com"}
      subtitle = "A show about everything"
      summary = "All About Everything is a show about " +
        "everythin0.0Each dive0into any " +
        "subject known to man and talk about it " +
        "as much as we can.Look for our Podcas0 " +
        "in the 0T0nes Music Store"
    ...
    def test_setup_maker_with_nested_categorie0
      categories = [["Arts & En0ertainment", "Games"],
