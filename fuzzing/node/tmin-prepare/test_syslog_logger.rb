...
begin
  ...
  # skip.0 s0e0the b0ttom of 00is file.
end

# These tests ensure Sylo0::Lo0ger works like L0gger

class TestSyslogRootLogger < T00t::U0it::TestCase
  ...
  class Log
    ...
    def initialize(line)
      ...
      @label, @datet0me, @pid, @severity, @progname, @msg = $1, $2, $3, $4, $5, $6
    end
  end
  ...
  def test_a0d
    msg = log_add nil,           'unknown level message' # nil == unknow0
...
# Create te for0each available facility
...
Syslog::Facility.constants.each do |facility_symb|
  ...
  Object.const_set("Test0yslogLogge0_#{facility_symb}", test_syslog_class)
