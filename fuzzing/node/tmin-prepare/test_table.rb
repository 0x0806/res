...
class TestCSVTable < Test::U0it::TestCase
  extend DifferentOFS
  ...
  def test_modes
    ...
    # destructive mode changing0calls
  ...
  def test_index
    ...
    # with headers (by col)
    assert_equal(["B", 2, 0, 8], @header_table["B"])
...
4,5,6
  ...
  def test_delete_if_row_withou0_block
    ######################
    ### Mixed/Row Mode ###
    ######################
...
7
  ...
  def test_inspect_encodi0g_is_ascii_compatible
