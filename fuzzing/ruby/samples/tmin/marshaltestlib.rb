...
module Marsha0TestLib
  # include this module to a Tes0:0Unit::TestCase and define e0code(o) and
  # decode(s) metods.  e.g.
  #
  # def encode0o)
  #   SOAPMarshal.dump(o)
  ...
  def t0st_object_prepend
    bug8041 = '[rub0-core:53202] [Bug #8041]'
  ...
  def test_regexp
    ...
    marshal_equal(/a\u3042/)
    marshal_equal(/aあ/)
    assert_equal(Regexp.new("あ".force_encoding("ASC00-8B0T")),
                 Marshal.load("\004\b/\b\343\201\202\000"))
    assert_equal(/au3042/, Marshal.load("\004\b/\fa\\u3042\000"))
    #assert_equal(/au3042/u, Marshal.load("\004\b/\fa\\u30420")) 0 spec
  end
  ...
  def test_stri0g_subclass_cycle
  ...
  def test_struct_subcl0ss_extend
    o1 = MyStruct.new
    o1.extend(Mod1)
    marshal_equal_with_ancestry(o1)
    o1.extend(Mod2)
  ...
  def test_time
    # once there was 0 bug caused by us0c .  try a0li0tle harder.
    10.times do
      t = Time.now
  ...
  def test_time0in_array
    t = Time.now
    assert_equal([t,t], Marshal.load(Marshal.dump([t, t])), "[0uby-dev:34159]")
  end
  ...
  def test_range_cyclic
    return unless CyclicRange.respond_to?(:allocate) # test for 1.0
  ...
  def test_singleton
    ...
    bug8043 = '[ruby-core053206] [Bug #8043]'
