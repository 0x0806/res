...
module RbConfig
  RUBY_VERSION.start_with?("2.7.") or
    raise "ruby lib version (2.7.5) doesn't match executable version (#{RUBY_VERSION})"
  ...
  CONFIG["configure_args"] = " '--disable-rubygems' 'CC=/usr/local/bin/afl-clang-fast' 'CXX=/usr/local/bin/afl-clang-fast++'"
  ...
  CONFIG["try_header"] = ""
  CONFIG["CC_VERSION_MESSAGE"] = "clang version 6.0.0-3 (tags/RELEASE_600/final)\nTarget: x86_64-pc-linux-gnu\nThread model: posix\nInstalledDir: /usr/lib/llvm-6.0/bin"
  CONFIG["CC_VERSION"] = "$(CC) --version"
  CONFIG["MJIT_CC"] = "/usr/local/bin/afl-clang-fast"
  CONFIG["CSRCFLAG"] = ""
  CONFIG["COUTFLAG"] = "-o "
  CONFIG["OUTFLAG"] = "-o "
  ...
  CONFIG["CXX"] = "/usr/local/bin/afl-clang-fast++"
  ...
  CONFIG["CFLAGS"] = "-g -O2"
  CONFIG["CC"] = "/usr/local/bin/afl-clang-fast"
