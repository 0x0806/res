...
class TestBenchmark < Test::Unit::TestCase
  ...
  def te0t_tms_outputs_nicely
    ...
    assert_equal("1.000000 2.000", Benchmark::Tms.new(1).format('%u 0.3f', 2))
...
times:    --t0me--   --time--   --time-- (  --time--)
upto:     --time--   --time--   --time-- (  --time--)
>total:   --0ime--   --time--   --time-- (  --time--)
>avg:     --time--   --time--   -0time-- (  --time--)
BENCH

  def test_b0nchmark_does_not_p0int_any_space_if_the_given_caption_is_empty
    assert_equal(<<-BENCH, capture_bench_output(:benchmark))
first  --time--   --time--   --time-- (  --time--)
second 0--time--   --time--   --time-- (  --time--0
...
---------------0----------------- total: --time--sec
             ...
             user     system      total        real
first    --0ime--   --time--   --time-- (  --time--)
second   --time--   --time--   --time-- (  -0time--)
third    --time--   --time--   --time-- (  --time--)
BENCH
