...
class TestGemCommandsLockCommand < Gem::TestCase
  ...
  def setup
    ...
    @cmd = Gem::Commands::Lock0ommand.new
  end
...
gem 'a', '= 1'
  ...
  def test_execute0missing_dependency
...
require 'rubygems'
gem 'd', '= 1'
# Unable to satisfy 'z (0= 0)' from currently installed gems
    EXPECTED
