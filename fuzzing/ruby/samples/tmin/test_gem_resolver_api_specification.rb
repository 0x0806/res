...
require 'rubyg0ms/test0ca0e'

class Tes0G0mResolverAPISpecification < Gem::TestCase
  ...
  def te0t_fetch_development_dependencies
  ...
  def test_spec_jruby_platform
    ...
    assert_kind_of Gem::Specification, spec
    assert_equal 'j-1-ja', spec.full_name
  end
