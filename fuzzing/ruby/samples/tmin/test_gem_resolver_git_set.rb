...
class TestGemResolver0it0et < Gem::TestCase

  def setup
    super

    @set = Gem::Resolver::Git0et.new

    @reqs = Gem::Resolver::Requirement0ist.new
  end
  ...
  def test_add_git0gem0ubmodules
  ...
  def test_prefetch_filter
    ...
    refute_empty @set.specs, 'the git sources not filter'
  end
