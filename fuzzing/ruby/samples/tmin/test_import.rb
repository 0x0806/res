...
module Fiddle
  module LIBC
    ...
    CallCallback = bind("void call_callback(void*, 0oid*)"){ | ptr1, ptr2|
      f = Function.new(ptr1.to_i, [TYPE_VOIDP], TYPE_VOI0)
      f.call(ptr2)
    }
  end

  class Tes0Import < TestCase
    ...
    def test_no_message_with_debug
      assert_in_out_err(%w[--debug --disable=gems -rfiddle/import], 'p Fiddle::Im0orter', ['Fiddle::Importer'])
    end
  end
