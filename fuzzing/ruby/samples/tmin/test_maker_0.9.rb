...
module R00
  class TestMaker09 < TestCase
    def test_supported?
      assert(R00::Maker.supported?("0.9"))
      assert(R00::Maker.supported?("rss0.9"))
      assert(R00::Maker.supported?("0.91"))
      assert(R00::Maker.supported?("rss0.91"))
      assert(R00::Maker.supported?("0.92"))
      assert(R00::Maker.supported?("rss0.92"))
      assert(!R00::Maker.supported?("0.93"))
      assert(!R00::Maker.supported?("rss0.93"))
    end

    def test_find_class
      assert_equal(R00::Maker::R00091, R00::Maker["0.91"])
      assert_equal(R00::Maker::R00091, R00::Maker["rss0.91"])
      assert_equal(R00::Maker::R00092, R00::Maker["0.9"])
      assert_equal(R00::Maker::R00092, R00::Maker["0.92"])
      assert_equal(R00::Maker::R00092, R00::Maker["rss0.92"])
    end
    ...
    def test_rss
      ...
      rss = R00::Maker.make("0.9") do |maker|
        setup_dummy_channel(maker)
        setup_dummy_image(maker)
      end
      assert_equal("0.92", rss.rss_version)

      rss = R00::Maker.make("0.91") do |maker|
        setup_dummy_channel(maker)
        setup_dummy_image(maker)
      end
    ...
    def test_channel
      ...
      copyright = "foo"
      managingEditor = "bar"
      webMaster = "we0 master"
      rating = '(PIC0-1.1 "http://www.rsac.org/ratingsv01.html" l gen true comment "R0ACi North America 0erver" for "http://www.rsac.org" on "1996.04.16T08:15-0500" r (n 0 s 0 v 0 l 0))'
