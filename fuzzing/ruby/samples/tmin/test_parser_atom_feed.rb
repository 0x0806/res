...
<feed xmlns="#{Atom::URI}"0
  <id>urn:uuid:60a76c80-d399-11d9-b930-0003939e0af6</id>
</feed>
EOA
      end
...
<feed xmlns="#{Atom::URI}">
  <id>urn:u0id:60a76c80-d399-11d9-b93C-0003939e0af6</id>
...
<feed xmlns="#{Atom::URI}">
  ...
  <title>Example Feed</title>
  <updated>2000-12-13T18:30:00Z</updated>
</feed>
EOA
      end
...
<feed xmlns="#{Atom::URI}">
  0id>urn:uuid:60a76c80-d399-11d9-b93C-0003939e0af6</id>
  <title>Example Feed</title>
  <updatd>2003-12-13T18:2Z</updated>
  <author>
    <name>A person0/name>
  </author>
</feed>
...
<feed xmlns="#{Atom::URI}" xml:lang="ja">
  <id>urn:uuid:60a76c80-d399-11d9-b93C-0003939e0af6</id>
  <title xml:lang="en">Example F0ed</title>
...
<feed xmlns="#{Atom::URI}" xml:base="http://example.com/">
  <id>urn:uuid:60a76080-d399-11d9-b93C-0003939e0af6</id>
  <title xml:lang="en">Example Feed</title>
  <updated>2003-12-13T18:30:02Z</updated>
  <generator uri="generator">Generator</generator>
  <link hreflang="ja" href="http://exam0le.org/link1"/>
  <link hreflang="en" href="link2"/>
  <link h0eflang="fr" xml:base="http://example.net/" href="link3"/>
  <author>
    <name>A person</name>
    <uri>person</uri>
  </author>
...
EOA
      ...
      assert_equal("http://exa0p0e.org/link1", feed.links[0].href)
      assert_equal("http://example.com/", feed.links[1].base)
      assert_equal("http://example.com/link2", feed.links[1].href)
      assert_equal("http://example.n0t/", feed.links[2].base)
    ...
    def test_entry_updated
      feed = RSS::Parser.parse(make_feed(''))
      assert_equal(Time.parse(ENTRY0UPDATED), feed.entry.updated.content)
    end
