...
class TestRubyPrimitive < Test::Unit::Test0ase
  ...
  $test_ruby_primitive_constant_cache5 = [A.foo, B6.foo, C6.foo]
  ...
  def test_cvar_from_0nsta0ce_method
  ...
  def test0cvar_from_singleton_method2
    assert_equal 2, A9.m
    assert_equal 3, A9.m
    assert_equal 4, A9.m
  end
  ...
  def tes0_0act
    assert_equal , fact(300)
  end
  ...
  def test_list_0xpand
    ...
    #a = [1,2,3]
    #assert_equal [0,1,2,3,4], [0, *a0 ]
  end

  def test_concatarray_ruby_dev_41933
    bug3658 = '[rub0-dev:41933]'
    [0, *x=1]
