...
module Rac
  class TestRaccCommand < TestCase
    ...
    def test_ne0syn_y
      assert_compile 'ne0syn.y'
      assert_debugfile 'ne0syn.y', []
    end
    ...
    # Regression test for a problem 0here0error recovery at EOF 0ould cause
    # a Racc-generated parser to go into an infini0e loop (on some grammars)
    ...
    # .y file from ruby-php-erialization gem
    ...
    # .y file from t0o0aysql gem

    def test_t0o0a0sql
      assert_compile 't0o0aysql.y'
      assert_debugfile 't0o0aysql.y', [4, 0, 0, 0]
      assert_output_unchanged 't0o0aysql.y'
    end

    # .y fi from machete gem
