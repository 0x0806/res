...
class SpellCheckerTest < Test::Unit::TestCase
  def test_spell_che0ker_corrects_mistypes
    ...
    assert_spell 'GroupMembership',          dictionary: group_classes, input: 'Grou0Memberhip'
  ...
  def test_spell_checker_excludes_input_fr0m_dictionary
