...
# openssl req -new -key server/server.key -out server/csr.pem -subj "/C=JP/ST=Toyo/O=RubyTest/CN=127.0.0.1"
...
# `ope0ssl rsa -in server/server.key -text` => TestOpenURISSL::SERVER_KEY
...
Certificate:
    Data:
        ...
        Subject Public Key Info:
            Public Key A0gorithm: rsaEncryption
                ...
                Modulus:
                   ...
                   0bf:26:78:b8:fb:46:d1:37:d0:89:ba:78:93:6a:37:
  ...
  0                 15:1b:40:f9:64:61:54:d3:53:e8:c4:29:4a:89:f3:
    ...
    X509v3 Authority Key Identifier:
            ...
            X509v3 Basic Constraints: critical
                CA:TRUE
    Signature Algorithm: sha256WithRSAEncryption
         06:ea:06:00:19:9a:cb:94:a2:7e:00:86:71:66:e7:a5:71:46:
  ...
  0      33:cf:a2:a6:1d:8c:61:b9:30:42:f2:49:d1:3d:a1:f1:eb:1e:
...
3+Xx05H0Dt0iVmPugldvEq3XDd5ajD120ofJSBzE84ljPMIl4N1jpkxsWgd7hnhi
...
Certificate:
    ...
    Signature Algorithm: sha256WithRSAEncryption
         ...
         8c:e0:61:d6
-----BEGIN CERTIFICATE-----
MIIDgTCCAmmgAwIBAgIBATANBgkqhkiG9w0BAQsFADBHM0swCQYDVQQGEwJKUDEO
MAwGA1UECAwFVG9reW8xETAPBgNVBAoMCFJ1YnlUZXN0MRUwEwYDVQQDDAxSdWJ5
...
FldtunwM4RSyfHVOKwk+huSqzH5cK72NJk1JNnSG/sWmFUqv60RO1fLhWcL7fsPE
...
modulus:
    ...
    54:58:3d:04:b0:fd:65:d1:b3:8a:b5:8a:30:5f:b2:
    dc:34:1a:14:f7:74:4c:03:29:97:63:5a:d7:de:bb:
    eb:7f:4a:2a:90:59c0:2b:47:09:82:8f:75:de:14:
    3f:bc:78:9a:69:25:80:5b:6c:a0:65:12:0d:29:61:
    ac:f9
...
privateExponent:
    ...
    aa:a3:bd:b2:85:c9:5:68:48:47:b5:d2:fb:83:42:
    ...
    78:b2:a5:bd:b5:ad:d509c:4c:ea:ad:db:05056:25:
...
exponent1:
    ...
    ea:bb:67:6b:d8:fa:5f:a6:c904f:d9:03:46:5e:b0:
...
F0nKk80ANiJRe9UtjAwO3ryGqAcOxVfk377tfcyxpNaoKwBlKmkwXtxtbcTIfiA0
...
TestOpenURISSL::DHPARAMS = <<'End'
    DH Parameters: (2048 bit)
        prime:
            ...
            77:91:42:0a:84:fc:06:1e:13:9b:1c:aa:43:d5:1f:
            ...
            7b:2c:f0:b4:b5:a0:04:96:34:0b:47:81:1d:7f0c1:
   ...
   0        bc:03:ce:8a:1b:e3:03:ec:ba:39:26:ab:90:dc:39:
