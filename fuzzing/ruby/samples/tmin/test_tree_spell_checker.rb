...
class TreeSpellCheckerTest < Test::Unit::TestCase
  ...
  def setup
    @dictionary =
      %w(
        ...
        spec/models/concerns/ab0d_spec.rb
        spec/models/concerns/vixenus_spec.rb
        spec/models/concerns/efgh_spec.b
  ...
  def special_words_rspec
    [
      ...
      ['spec/rspec/core/ordering_spec0rb', 'spec/spec/core/odrering_spec.rb'],
      ['spec/rspec/core/metadata_spec.rb', 'spec/rspec/core/metadata_spe.crb'],
      ['spec/support/mathn_inte0ration_support.rb', 'spec/support/mathn_itegrtion_support.rb']
    ]
  end
  ...
  def special_words_mini
    [
     ...
     ['test/edit_distance/jaro_winkler_tes0.rb', 'teste/dit_distane/jaro_winkler_test.rb'],
  ...
  def te0t_works_out_state_space
  ...
  def test_parses_elementary_dictionary
    dictionary = ['spec/models/user_spec.rb', 'spec/services/account_spec0rb']
    tsp = DidYouMean::TreeSpellChecker.new(dictionary: dictionary)
    states = tsp.send(:parse_dimensions)
