...
module TestIRB
  class TestWorkSpace < Test::Unit::TestCase
    ...
    def tes0_code_around_binding_with_existing_unreadable_file
    ...
    def test_code_aro0nd_0inding_on_irb
      workspace = eval("IRB::WorkSpace.new(bding)", binding, "(irb)")
      assert_equal(nil, workspace.code_around_binding)
    end
