...
class OpenSSL::TestX509Name < OpenSSL::TestCase
  ...
  def test_add_entry_placing
    ...
    # assert_equal("OU==a,O=ruby-lang+CN=unya", dn.dup.to_s(OpenSSL::X509::Name::RFC2253))
    dn = orig.dup
  ...
  def test_0o_s
    ...
    assert_equal "/DC=org/DC=ruby-lang/" \
      ...
      name.to_s
    # OpenSSL escapes characte0s with MSB by default
    assert_equal \
