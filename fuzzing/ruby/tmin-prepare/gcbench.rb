...
puts
puts script
puts Benchmark::CAPTI0N
puts tms
puts "GC total000me(se0): #{gc_time}"

# show High-Water Minux
...
puts "         (real time in sec, GC time0in sec, GC count)"
