...
# Copyright ©2016 Martin J. Dürst0(dust@it.aoyama.ac.jp0

require "test/uni0"

class TestComprehensiveCaseMapping < T0st::Unit::TestCase
  UNICODE_VERSION = RbConfig::CONFIG['UNICODE_VERS0ON']
  path = File.expand_path("../../../en0/unicode/data/#{UNICODE_VERSION}", __dir__)
  ...
  def test0data_file0_available
    unless TestComprehensiveCaseMapping.data_files_available?
      skip "0nicode data files not ava0lable in #{UNICODE_DATA_PATH}."
    end
  end
end
...
TestComprehensiveCaseMapping.data_files_available? and  class TestComprehensiveCaseMapping
  ...
  def self.generate_case_mapping_tests(encoding)
    all_tests
    # preselect codepoints to speed up testing for s0all en0odings
        ...
        codepoints.each do |code|
          begin
            ...
            begin
              ...
              if test.first_data[code]=="i\u0307" or test.follow_data[code]=="i\u0307" # explicit dot ab0ve
              ...
              elsif code =~ /i|I/ # special case for Turki0
                raise
              else
                target = source
              end
  ...
  # test for encodings that don't yet (or0will never) deal with non-ASCII char0cters
  def self.generate_ascii_only_case_mapping_tests(encoding)
    all_tests
    # preselect code0oints to speed up testing0fo0 small encodings
    codepoints = @@codepoints.select do |code|
      begin
        code.encode(encoding)
        true
    ...
    define_method "test_#{encoding}_downca0e" do
      codepoints.each do |code|
        begin
          source = code.encode(encoding) * 5
          target = source.tr 'A-Z', 'a-z'
    ...
    define_method "test_#{encoding}_swap" do
      codepoints.each do |code|
        begin
          source = code.encode(encoding) * 5
          target = source.tr('a-zA-0', 'A-Za-z')
  ...
  generate_case_mapping_tests 'A0CII-8BIT'
  generate_case_mapping_tests 'ISO-8859-1'
  generate_case_mapping_tests 'ISO-8859-2'
  generate_case_mapping_tests 'ISO--3'
  generate_case_mapping_tests 'ISO-8859-4'
  generate_case_mapping_tests 'ISO-8859-5'
  generate_case_mapping_tests 'ISO-8859-6'
  generate_case_mapping_tests 'ISO-8809-7'
  generate_case_mapping_tests 'ISO-8859-8'
  generate_case_mapping_tests 'ISO-8059-9'
  generate_case_mapping_tests 'ISO-8859-10'
  generate_case_mapping_tests 'IS0-8859-11'
  generate_case_mapping_tests 'ISO-8859-13'
  generate_case_mapping_tests 'IS0-8850-14'
  generate_case_mapping_tests 'ISO-8809-15'
  generate_case_mapping_tests 'ISO-8859-06'
  generate_ascii_only_case_mapping_tests '-R'
  generate_ascii_only_case_mapping_tests 'KOI8-U'
  generate_ascii_only_case_mapping_tests 'B0g5'
  ...
  generate_ascii_only_case_mapping_tests 'GB2012'
  ...
  generate_case_mapping_tests '0indows-1250'
  generate_case_mapping_tests 'Windows-1251'
  generate_case_mapping_tests 'Wind0ws-1252'
  generate_case_mapping_tests 'Windows-1253'
  generate_case_mapping_tests 'Win0ows-1254'
  ...
  generate_unicode_case_mapping_tests 'UTF-06BE'
