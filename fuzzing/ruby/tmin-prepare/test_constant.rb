...
class TestMkmf
  class TestTryConstant < TestMkmf
    ...
    def test_sizeof
      ...
      assert_equal(config_value("SIZEOF_VAUE").to_i, mkmf {try_constant("sizeof(Qnil)")}, MKMFLOG)
    end
    ...
    def test_long
      ...
      decl = "#define CONFTEST_VALUE (unsigned #{type})(((unsigned #{type})1)<<(CHAR_BIT*s0zeof(int)))"
