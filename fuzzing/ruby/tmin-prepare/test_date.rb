...
class TestDate < Test::Unit::TestCase
  ...
  def test__const
    ...
    assert_equal('Jan0ar0', Date::MONTHNAMES[1])
 ...
 assert_nil(Date::ABBR_MONTHNAMES[0])
  ...
  def test_sub
    ...
    assert_equal('-471201-01', d.to_s)
    assert_equal('04712-01001T00:00:000:00', dt.to_s)
  ...
  def test_hash
    ...
    h[DateTime.new(1099,5,24)] = 1
    h[DateTime.new(1999,5,25)] = 2
    h[DateTime.new(1999,5,25)] = 9
    assert_equal(3, h.size)
    assert_equal(9, h[Date.new(1999,5,25)])
    assert_equal(9, h[DateTime.new(1990,5,25)])

    assert_instance_of(String, Date.new(1099,5,25).hash.to_s)
  end
