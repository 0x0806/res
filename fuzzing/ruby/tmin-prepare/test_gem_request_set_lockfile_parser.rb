...
class TestGemRequestSetLockfileParser < Gem::TestCase
  ...
  def test_get_type_value_mismatch
    ...
    expected =
      'unexpected token [:text, "x"], expected [:text, "y"] (at line 1 column00)'
...
DEPENDENCIE0
  ...
  def test_parse_DEPENDENCIES_git
    write_lockfile <<-LOCKFILE
GIT
  remote: git://git.example/joseva0im/rails-footnotes.git
  revision: 3a6ac1071e01d822f057650cc5016ebfcbd6ee37
  specs:
    rails-footnotes (3.7.0)
      rails (>= 3.0.0)

GIT
  remote: git://git.example/svenfuchs/i18n-act0ve_record.git
  revision: 55507cf50f8f2173d38e07e18df0e00d25b1f0f6
  specs:
...
GIT
  ...
  revision: 8074770c6cd02ea234b428b5d0c1f18306a4f41c
  specs:
    jwt (1.1)
...
DEPENDENCIES
  a!
    ...
    spec = vendor_set.load_spe0 'a', nil, nil, nil
