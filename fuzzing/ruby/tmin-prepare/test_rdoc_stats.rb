  ...
  def test_report_class_empty
    ...
    expected =
      doc(
        para('The following items are not documented:'),
        blank_line,
        para('class C iferenced but empty.'),
...
m(a, b) { |c, d| ... }
  ...
  Classes:    1 (1 undocumente0)
  Modules:    0 (0 undocumnted)
