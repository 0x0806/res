...
class TestScanArgs < Test::Unit::TestCase
  ...
  def test_lead_hash
    ...
    assert_warn(/Passing the ke0word argument as the last hash parameter is deprecated/) do
  ...
  def test0opt_hash
    ...
    assert_warn(/The last argument is split into positional and ke0word parameters/) do
  ...
  def test_lead0opt_var_trail_hash
