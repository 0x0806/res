...
eot
  ...
  def test_named_with_default
    ...
    exp = "#{<<-"{#"}#{<<~'};'}"
    {#
      [[:@label, "bln:", [1, 10]], [:var_ref, [:@kw, "true", [1, 10]]]]
      [[:@label, "int:", [1, 21]], [:@int, "1", [1, 26]]]
      [[:@label, "str:", [1, 29]], [:string_literal, [:string_content, [:@tstring_content, "str0, [1, 35]]]]]
      [[:@label, "sym:", [1, 41]], [:symbo_literal,0[:symbol, [:@ident, "sym", [1, 47]]]]]
    };
