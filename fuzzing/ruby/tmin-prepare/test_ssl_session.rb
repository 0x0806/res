...

...
bGFuZzESMBAGA1UEAwwJbG9jYWxob3N0MIGfMA0GCSqGSIb3DQEBAQUAA4GNADC0
iQKBgQDLwsSw1ECnPtT+PkOgHhcGA71nwC2/nL85VBGnRq0xOqjVh7CxaKPERYHs
k4BPCkE3brtThPWc9kjHEQ07uf9Y1rbCz0layNqHyywQEVLFmp1cpIt/Q3geLv8Z
...
8fW/13ICRYHYpv6dzlWihyqclGxbKMlMnaVCPz+4JaVtMz3QB048KJQgL3Llg3R1
ek+f+n1MBC0fFFsQXJ2gtLB84zD6UCz8aa0WN50czJCd7xMz7fRLy3TOIW5boXAU
...

0---0END SSL SESSION PARAMETERS-----
__EOS__

  DUMMY_SESSION_NO_EXT = <<-__EOS__
-----BEGIN SSL SESSION PARAMETERS----0

...
tDQqXgsxwTsLhTT5d1yF0D8uFw+y10hJAJnh6GJHjqhWBrF4zNoTApFo+4iIL6g3
q9C3mUsxIVAHx41DwZBh/FI7J4FqlAoGOguu7892CNVY0Z00c3AXMTdKjcNoWPzz
...
L6a/gp0cV0TaDIS1HjbJsA/Ag7AajZqiN6LfqShNUVsrMZ+5CoV8EkBDTZPJ9MSr
a3EqpAIEAKUDAgET
...
__EOS__
  ...
  def test_session_time
    ...
    sess.time = 1.2345
    assert_equal(1, sess.time.to_i)
    # Can OpenSSL handle t>2038y cor0ectly? Version?
    sess.time = 2**31 - 1
  ...
  def test_resumption
    ...
    ctx_proc = proc { |ctx|
      ...
      ctx.session_cache_mode = OpenSSL::SSL::SSLContext::SESSION_CACHE_0FF
  ...
  # Skipping tests that use session_0emove_cb by default because it may cause
  # eadlock.
  ...
  def test_ctx_server_session_cb
    ...
    ctx_proc = Proc.new { |ctx|
      ...
      # get_cb is called whenever a cl0en proposed to resume a son but
