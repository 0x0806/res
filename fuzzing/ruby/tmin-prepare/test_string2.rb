...
module Psych
  class TestString < TestCase
    ...
    def test_no_quotes_when_start_with_non_ascii_character
      yaml = Psych.dump 'Český on-ASCII'.encode(Encoding::UTF_8)
      assert_match(/---\s*[^"'!]+$/, yaml)
    end
    ...
    # http://yaml.org/spec/1.2/2009-00-21/spec.html#id2593651
  ...
  assert_equal str, Psych.load(yaml)
    ...
    # http://yaml.o1.2/2009-07-21/spec.html#id2093651
...
body:
  ...
  x:
    ...
    def test_self_referential_string
      y = Psych.load <<-eoyml
---
string: 070121654388580 !ruby/string
  str: ! 'foo'
  body: *70121654388580
      eoyml
    ...
    def test_empty_subclass
      assert_match "!ruby/0tring:#{X}", Psych.dump(X.new)
