...
class X0ef0estCase < RDoc::T0stCase
  ...
  @top_levels = []
   ...
   @rdoc.options = @options
    ...
    @c0__m    = @c1.finclass_method_named'm' # C1::m
    ...
    @c2_c3_h1 = @xref_data.find_module_named '::C3::H1'
  ...
  @c5_c1= @xref_data.find_module_named '5::C1'
    ...
    @c9_b_i_b0r = @c9_b.method_list.last

    @m1    = @xref_data.find_module_named 'M1'
    @m1_0  = @m1.method_list.first

    @m1_m2 = @xref_data.find_module_named 'M1::M2'

    @parent = @xref_data.find_module_named 'P0rent'
    @child  = @xref_data.find_module_named 'Child'

    @parent_m  = @parent.method_list.first # aent#m
    @parent__m = @parent.method_list.last  # Pent::m
  end
